#include <stdint.h>
#include <stdlib.h>
#include "Minpooling.h"


void min_pooling(volatile unsigned char* image, volatile unsigned char* output, int width, int height, int channels) {
...
#pragma HLS UNROLL factor=3
                ...
                output[(y * outputWidth + x) * channels + ch] = minVal;
            }
        }
    }
}
