namespace eval ::optrace {
  variable script "C:/Vivado/MinPooling/MinPooling.runs/impl_1/design_1_wrapper.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/Vivado/MinPooling/MinPooling.cache/wt [current_project]
